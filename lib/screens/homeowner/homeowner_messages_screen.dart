    ...
    return Scaffold(
      ...
      body: uid == null
          ...
          : StreamBuilder<QuerySnapshot>(
              stream: MessageService.subscribeToConversations(uid, 'homeowner'),
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Contractors will message you after unlocking your projects',
                          style: TextStyle(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      final contractorName =
                          conv['contractorName'] ?? 'Contractor';
                      final contractorUid = conv['contractorUid'] as String? ?? '';
                        ...
                        confirmDismiss: (_) async {
                          final confirmed = await showDialog<bool>(
                            ...
                            builder: (ctx) => AlertDialog(
                              ...
                              content: Text(
                                  'Delete your conversation with $contractorName? This cannot be undone.'),
                              actions: [
                                TextButton(
                                    onPressed: () =>
